...
import ERC20FixedSupplyContract from "./../../contracts/ERC20FixedSupply.json";
    ...
    if (signer) {
      try {
        const contract = new ContractFactory(
          ERC20FixedSupplyContract.abi,
          ERC20FixedSupplyContract.bytecode,
          signer
        );
...
export default ERC20FixedSupply;
